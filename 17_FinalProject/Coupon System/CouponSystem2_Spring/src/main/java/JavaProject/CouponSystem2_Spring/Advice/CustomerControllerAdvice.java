...
/**
 * Customer Controller Advice Class - used to advise user regarding system errors
 */
@RestControllerAdvice
public class CustomerControllerAdvice {
    /**
     * Method used to handle errors arriving from Customer Exceptions
    ...
    public ErrorDetails HandleError(Exception exception) {
        return new ErrorDetails("Customer Error",exception.getMessage());
    }
